...
<body>
	...
	<form class="signin" action="operation.php" method="post" align="center">
		...
		<p>Username <input type="text" name="username" required><br><br> Password <input type="password" name="password" required><br><br>Confirm Password <input type="password" name="conpassword" required><br><br> Description <input type="text" name="description"><br><br>

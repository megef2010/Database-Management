...
<div class="header"><span class="logo"><h1>MeTube Logo</h1></span> <span class="searchbar"><form class="search" action="../search.php" method="post"><input type="text" placeholder="" name="searchbar">
		<button type="submit">
